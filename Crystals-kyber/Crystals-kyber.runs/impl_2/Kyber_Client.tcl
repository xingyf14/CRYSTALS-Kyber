...
set rc [catch {
  ...
  create_report "impl_2_opt_report_drc_0" "report_drc -file Kyber_Client_drc_opted.rpt -pb Kyber_Client_drc_opted.pb -rpx Kyber_Client_drc_opted.rpx"
...
set rc [catch {
  ...
  create_report "impl_2_place_report_io_0" "report_io -file Kyber_Client_io_placed.rpt"
  create_report "impl_2_place_report_utilization_0" "report_utilization -file Kyber_Client_utilization_placed.rpt -pb Kyber_Client_utilization_placed.pb"
  create_report "impl_2_place_report_control_sets_0" "report_control_sets -file Kyber_Client_control_sets_placed.rpt"
...
set rc [catch {
  ...
  create_report "impl_2_route_report_drc_0" "report_drc -file Kyber_Client_drc_routed.rpt -pb Kyber_Client_drc_routed.pb -rpx Kyber_Client_drc_routed.rpx"
  create_report "impl_2_route_report_methodology_0" "report_methodology -file Kyber_Client_methodology_drc_routed.rpt -pb Kyber_Client_methodology_drc_routed.pb -rpx Kyber_Client_methodology_drc_routed.rpx"
  create_report "impl_2_route_report_power_0" "report_power -file Kyber_Client_power_routed.rpt -pb Kyber_Client_power_summary_routed.pb -rpx Kyber_Client_power_routed.rpx"
  create_report "impl_2_route_report_route_status_0" "report_route_status -file Kyber_Client_route_status.rpt -pb Kyber_Client_route_status.pb"
  create_report "impl_2_route_report_timing_summary_0" "report_timing_summary -file Kyber_Client_timing_summary_routed.rpt -warn_on_violation  -rpx Kyber_Client_timing_summary_routed.rpx"
  create_report "impl_2_route_report_incremental_reuse_0" "report_incremental_reuse -file Kyber_Client_incremental_reuse_routed.rpt"
  create_report "impl_2_route_report_clock_utilization_0" "report_clock_utilization -file Kyber_Client_clock_utilization_routed.rpt"
